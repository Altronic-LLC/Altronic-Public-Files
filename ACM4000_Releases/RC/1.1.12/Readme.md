# [MDI 1.1.12](https://github.com/Altronic-LLC/Altronic-Public-Files/blob/main/ACM4000_Releases/RC/1.1.12/mdi-1.1.12.atf)
...
#### Bug Fixes:
- **Watchdog/Blackout Issue at High Temps:** Fixed an issue where the software watchdog was triggered around 90C CM4 temperature and triggered a reboot cycle, the watchdog has been removed.

## Where To Find This Release

### ACM-4000 bootloader update version 1.1.12
...
1. **Download MDI 1.1.12**: [Download from GitHub](https://github.com/Altronic-LLC/Altronic-Public-Files/raw/refs/heads/main/ACM4000_Releases/RC/1.1.12/mdi-1.1.12.atf?download=)
