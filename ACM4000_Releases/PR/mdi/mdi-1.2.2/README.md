# [MDI 1.2.2](https://github.com/Altronic-LLC/Altronic-Public-Files/blob/main/ACM4000_Releases/PR/mdi/mdi-1.2.2/mdi-1.2.2.atf)
...
- **Default Master AWI Version 2.0.5:** Updated default master AWI version to 2.0.5.
- **Added support for binary protocol to AWI** Added support for binary protocol to MDI-Gateway, which decreases load on cpu for AWI value updates.
- **Datalogging Conistency:** Increased consistency of logging data to avoid blank values when full exporting.
- **RTU Exponential Backoff:** Added Expenontial backoff to polling scheduler, Which resolves slowdown of data when having several disconnected Modbus RTU devices.
...
- **Update Master AWI:** Updated Master AWI to version 2.0.5
- **RS485 Timeout Option:** Added RS485 port timeout option(how long before)
- **Sending Data to DE-400:** Added the ability to forward data to the de-4000 when register has ForwardToDE set to true inside of the device profile.

   

## Where To Find This Release

### ACM-4000 bootloader update version 1.2.2
...
1. **Download MDI 1.2.2**: [Download from GitHub](https://github.com/Altronic-LLC/Altronic-Public-Files/raw/refs/heads/main/ACM4000_Releases/PR/mdi/mdi-1.2.2/mdi-1.2.2.atf?download=)
